...
const ShareAppButton = ({ variant = "icon", className = "" }: ShareAppButtonProps) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <p className="font-display text-sm text-card-foreground px-2 pt-1 pb-2">
          Share Dead Set
        </p>
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-body text-card-foreground hover:bg-muted transition-colors"
        >
