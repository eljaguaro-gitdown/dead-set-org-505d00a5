...
const SHARE_URL = "https://dead-set-harmony.lovable.app";
const SHARE_TITLE = "Dead Set — Build Your Dream Dead Show";
const SHARE_TEXT =
  "Check out Dead Set — an AI-powered Grateful Dead setlist builder. Build your dream show, explore eras, and listen to legendary versions. ⚡🌹";
