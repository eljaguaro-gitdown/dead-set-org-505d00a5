    ...
    <PageLayout>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[radial-gradient(circle,hsl(var(--dead-gold)/0.08),transparent_70%)]" />
          <div className="absolute top-1/3 left-1/4 w-[400px] h-[400px] rounded-full bg-[radial-gradient(circle,hsl(var(--dead-red)/0.05),transparent_70%)]" />
        </div>
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-8 relative z-10 text-center"
        >
          <StealYourFace size={150} />

          <div className="space-y-4">
            <h1 className="font-display text-6xl sm:text-8xl md:text-9xl tracking-tight text-foreground leading-none">
              Dead Set
            </h1>
            <div className="w-24 h-px bg-primary mx-auto" />
            <p className="font-marker text-lg sm:text-xl text-muted-foreground max-w-md mx-auto tracking-wide uppercase">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button
              size="lg"
              onClick={() => navigate("/auth")}
              className="font-display text-base px-10 py-6 bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_30px_hsl(var(--glow-gold))] tracking-widest uppercase"
            >
              Start Building
            </Button>
            <Button
              ...
              size="lg"
              onClick={() => navigate("/auth")}
              className="font-body text-base px-10 py-6 border-border text-foreground hover:bg-muted hover:border-primary/40 tracking-wide"
            >
              I Have an Account
            </Button>
          </div>
        ...
        <motion.div
          ...
          className="mt-20 mb-8 relative z-10"
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <button
                key={era}
                className={`px-4 py-2 text-sm font-hand text-muted-foreground border rounded-sm transition-all duration-300 cursor-default ${color}`}
              >
                <span className="font-marker text-xs tracking-wide">{era}</span>
                <span className="text-xs text-muted-foreground/60 ml-2">{years}</span>
              </button>
            ))}
          </div>
        </motion.div>
